...
// all the body parts
var legGeometry = new THREE.CylinderGeometry( 10, 8, 60, 10, 1, false );		
var armGeometry = new THREE.CylinderGeometry( 10, 8, 50, 10, 1, false );		
var bodyGeometry = new THREE.CylinderGeometry( 20, 17, 100, 10, 1, false ); 
...
//loader.load( 'http://www.xelendt.com/documents/Deadmau5.obj', function ( object ) {
loader.load( 'Deadmau5_Head.obj', function ( object ) {
   ...
   /* object.position.y = 150;
    ...
    Body.add( object );
    var deadmau5Mesh = new THREE.Mesh( object, material );
    deadmau5Mesh.position.x = 0;
    deadmau5Mesh.position.y = 120;
    deadmau5Mesh.position.z = 0;
    object.add( deadmau5Mesh );
    deadmau5Mesh.castShadow = true;
    deadmau5Mesh.receiveShadow = true;*/
    //scene.add( object );
...
var render = function () {
    ...
    parent.position.y = 0;          // set to identity matrix
    ...
    */
    ...
    //var lowLeft = joints[LKNEE].position.y - jointMeshs[LKNEE].position.y;
    var KneeposLeft = Math.cos(joints[LHIPJOINT].rotation.z)*Math.cos(joints[LHIPJOINT].rotation.x)*60;
    var FootposLeft = Math.cos(joints[LKNEE].rotation.z+joints[LHIPJOINT].rotation.z)*Math.cos(joints[LKNEE].rotation.x+joints[LHIPJOINT].rotation.x)*60 + KneeposLeft;
    
    var KneeposRight = Math.cos(joints[RHIPJOINT].rotation.z)*Math.cos(joints[RHIPJOINT].rotation.x)*60;
    var FootposRight = Math.cos(joints[RKNEE].rotation.z+joints[RHIPJOINT].rotation.z)*Math.cos(joints[RKNEE].rotation.x+joints[RHIPJOINT].rotation.x)*60 + KneeposRight;

    var footdiff = Math.max( FootposLeft, FootposRight );

    //var KneeposLeft = Math.cos(joints[LHIPJOINT].rotation.x)*60;
    //var FootposLeft = Math.cos(joints[LKNEE].rotation.x+joints[LHIPJOINT].rotation.x)*60 + KneeposLeft;

    //console.log("foot height" + (FootposLeft));
    parent.position.y -= 120-footdiff  - 5;
